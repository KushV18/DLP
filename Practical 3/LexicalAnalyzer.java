...
public class LexicalAnalyzer {
    ...
    public static void analyzeFile(String fileName) {
        try {
            ...
            System.err.println("Error: File 'ex.c' not found in the current directory");
            System.err.println("Make sure 'ex.c' exists in the same directory as this program");
        } catch (IOException e) {
